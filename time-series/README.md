...
- [Sensor Domain Adaptation And Dataset Similarity](sensor-domain-adaptation-and-dataset-similarity/README.md): standalone CVB-era repo on proxy A-distance, sensor-domain comparison, and preprocessing choices for HAR time-series windows.
- [Time-Series Data Augmentation](time-series-data-augmentation/README.md): standalone CVB-era repo on augmentation strategies for sensor time series and human activity recognition.
- [Time-Series Domain Adaptation Notes](time-series-domain-adaptation-notes/README.md): standalone CVB-era repo preserving transfer-learning, domain-adaptation, HAR, and time-series ML reference notes.
...
- [Singular Spectrum Analysis in R](../articles/2017/2017-03-17-Singular-Spectrum-Analysis-in-R.md) (2017-03-17)
- [Memory-Efficient Windowing of Time Series Data in Python: 1. Memory Strides in NumPy](../articles/2019/2019-05-03-Memory-Efficient-Windowing-of-Time-Series-Data-in-Python-Memory-Strides-in-NumPy.md) (2019-05-03)
