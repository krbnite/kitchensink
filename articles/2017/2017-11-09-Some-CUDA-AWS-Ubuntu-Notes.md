...
> Import note: the original blog article referenced a `cuda-deviceQuery.png`
> screenshot here, but that image asset was not present in the website repo
> when this article was imported.
...
```
> Import note: the original blog article referenced a `cuda-bandwidthTest.png`
> screenshot here, but that image asset was not present in the website repo
> when this article was imported.
