# Human Activity Recognition Data and Models
...
- Historical note: Curated in 2026 from draft notes originally committed in `krbnite.github.io` from 2019-09-25 to 2019-09-26. The source draft histories were imported into this repository before this consolidation step.
- Link-list note: This is a historical `LINK-LIST` artifact, not a polished explanatory article.
- Curation note: A historical HAR/wearables data-and-model resource list.

### Source Drafts

- `2019-09-25-Human-Activity-Recognition-Data-and-Models.md`
